# Lists active videos whose quiz JSON lacks French options (fr.correctAnswer
# / fr.wrongAnswer). Output feeds the manual French fill-in pass.
...
select id,
       ...
       quiz->'fr'->>'correctAnswer'  as fr_c,
       quiz->'fr'->>'wrongAnswer'    as fr_w
from videos
where status='active'
