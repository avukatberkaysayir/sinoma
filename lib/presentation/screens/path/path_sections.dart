...
const List<(String zh, String tr, String en, String ko, String ja, String id, String vi, String th, String ru, String es, String pt)> _kBoboLines = [
  ('加油!', 'Bugün de birlikte çalışalım mı?', 'Shall we practise together today?', '오늘도 같이 공부해 볼까요?', '今日も一緒に勉強しましょうか？', 'Belajar bareng lagi hari ini, yuk?', 'Hôm nay cùng học nữa nhé?', 'วันนี้เรามาเรียนด้วยกันไหม?', 'Позанимаемся сегодня вместе?', '¿Practicamos juntos hoy también?', 'Vamos praticar juntos hoje também?'),
  ...
  ('你最棒!', 'Serini koru, ben buradayım 🏮', 'Keep your streak — I\'m right here 🏮', '스트릭을 지켜요, 제가 곁에 있을게요 🏮', '連続記録を守りましょう、私がついています 🏮', 'Jaga rentetanmu — aku di sini 🏮', 'Giữ chuỗi của bạn nhé, mình luôn ở đây 🏮', 'รักษาสถิติต่อเนื่องไว้นะ ฉันอยู่ตรงนี้ 🏮', 'Не теряй свою серию — я рядом 🏮', 'Mantén tu racha — aquí estoy 🏮', 'Mantenha sua sequência — estou aqui 🏮'),
  ('一起学吧!', 'Bugünkü çayevi siparişlerine baktın mı? 🧧', 'Checked today\'s tea house orders? 🧧', '오늘 찻집 주문은 확인했나요? 🧧', '今日の茶館の注文は確認しましたか？ 🧧', 'Sudah cek pesanan kedai teh hari ini? 🧧', 'Đã xem đơn hàng quán trà hôm nay chưa? 🧧', 'ดูออร์เดอร์ร้านน้ำชาวันนี้หรือยัง? 🧧', 'Заглянул в сегодняшние заказы чайной? 🧧', '¿Viste los pedidos de la casa de té de hoy? 🧧', 'Já viu os pedidos da casa de chá de hoje? 🧧'),
  ('万事开头难', 'Her işin başı zordur — başlamak yeter.', 'Every beginning is hard — just start.', '시작이 반이에요 — 일단 시작해 봐요.', '何事も始めが難しい — まず始めましょう。', 'Setiap awal itu sulit — mulai saja dulu.', 'Vạn sự khởi đầu nan — cứ bắt đầu thôi.', 'การเริ่มต้นทุกอย่างนั้นยาก — แค่เริ่มก็พอ', 'Любое начало трудно — просто начни.', 'Todo comienzo es difícil — solo empieza.', 'Todo começo é difícil — é só começar.'),
];
