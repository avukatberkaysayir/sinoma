...
// Web implementation — youtube_player_iframe_web is patched to use
// dart:ui_web.platformViewRegistry (Flutter 3.19+ API).
// Identical to the mobile implementation; no stub needed.
