...
const Map<String, List<Landmark>> kCityLandmarks = {
  ...
  'zunyi': [
    Landmark(icon: 'huiyi', photo: 'huiyi', nameTr: 'Zunyi Konferansı', nameEn: 'Zunyi Conference', descTr: '1935\'te devrimin kaderini değiştiren toplantının yapıldığı ev, kızıl tarihin dönüm noktasıdır.', descEn: 'The house of the 1935 meeting that changed the revolution\'s fate is a turning point of red history.'),
    Landmark(icon: 'moutai', photo: 'moutai', nameTr: 'Moutai Kasabası', nameEn: 'Moutai Town', descTr: 'Chishui kıyısındaki kasabada damıtılan Moutai, Çin\'in ulusal içkisi sayılan efsanevi baijiu\'dur.', descEn: 'Distilled in the town on the Chishui banks, Moutai is the legendary baijiu hailed as China\'s national drink.'),
    Landmark(icon: 'loushan', photo: 'loushan', nameTr: 'Loushan Geçidi', nameEn: 'Loushan Pass', descTr: 'Dağları yaran sarp geçit, Mao\'nun ünlü şiirine konu olan tarihi muharebenin sahnesidir.', descEn: 'The steep pass cutting the mountains is the scene of the historic battle immortalised in Mao\'s famous poem.'),
    Landmark(icon: 'chishui', photo: 'chishui', nameTr: 'Chishui Şelaleleri', nameEn: 'Chishui Falls', descTr: 'Kızıl Danxia kayalıklarından dökülen şelaleler ve bambu ormanları, \'kızıl nehir\' vadisini doldurur.', descEn: 'Waterfalls pouring off red Danxia cliffs and bamboo groves fill the \'red river\' valley.'),
  ],
  'liupanshui': [
    Landmark(icon: 'coolcity', photo: 'coolcity', nameTr: 'Serin Şehir', nameEn: 'Cool City', descTr: 'Yazın 19 dereceyi geçmeyen havasıyla Liupanshui, \'Çin\'in serin başkenti\' diye anılır.', descEn: 'With summers that rarely pass 19°C, Liupanshui is called \'China\'s cool capital\'.'),
    Landmark(icon: 'coal', photo: 'coal', nameTr: 'Güneybatının Kömür Denizi', nameEn: 'Coal Sea of the Southwest', descTr: 'Zengin kömür damarlarıyla şehir, güneybatı Çin\'in enerji ocağıdır.', descEn: 'Rich coal seams make the city the energy hearth of southwest China.'),
    Landmark(icon: 'grassland', photo: 'grassland', nameTr: 'Wumeng Çayırları', nameEn: 'Wumeng Grasslands', descTr: 'Bulutlara komşu Wumeng platosunun uçsuz çayırları, at sürüleri ve rüzgâr gülleriyle bezelidir.', descEn: 'The endless highland meadows of the Wumeng plateau are dotted with horse herds and wind turbines.'),
    Landmark(icon: 'kiwi', photo: 'kiwi', nameTr: 'Kırmızı Özlü Kivi', nameEn: 'Red-Heart Kiwifruit', descTr: 'Serin yaylalarda yetişen kırmızı özlü kivi, şehrin tatlı yeşil hazinesidir.', descEn: 'Red-heart kiwifruit grown on the cool highlands is the city\'s sweet green treasure.'),
  ],
  'anshun': [
    Landmark(icon: 'huangguoshu', photo: 'huangguoshu', nameTr: 'Huangguoshu Şelalesi', nameEn: 'Huangguoshu Waterfall', descTr: 'Asya\'nın en büyük şelalesi, gökkuşağı saçan sis bulutuyla 77 metreden gürler.', descEn: 'Asia\'s largest waterfall thunders down 77 metres, its mist scattering rainbows.'),
    Landmark(icon: 'dixi', photo: 'dixi', nameTr: 'Dixi Yer Operası', nameEn: 'Dixi Ground Opera', descTr: 'Ahşap savaşçı maskeleriyle köy meydanlarında oynanan Dixi, \'Çin operasının yaşayan fosili\'dir.', descEn: 'Performed in village squares with wooden warrior masks, Dixi is the \'living fossil of Chinese opera\'.'),
    Landmark(icon: 'batik', photo: 'batik', nameTr: 'Batik Sanatı', nameEn: 'Batik Art', descTr: 'Buyi ve Miao kadınlarının balmumuyla çizip çivit mavisine boyadığı kumaşlar, Anshun\'un imzasıdır.', descEn: 'Cloth drawn with wax and dyed indigo by Buyi and Miao women is Anshun\'s signature craft.'),
    Landmark(icon: 'tunpu', photo: 'tunpu', nameTr: 'Tunpu Köyleri', nameEn: 'Tunpu Villages', descTr: 'Ming ordusunun taş garnizon köylerinde yaşayanlar, 600 yıllık kıyafet ve lehçeyi bugün de sürdürür.', descEn: 'Villagers of the Ming army\'s stone garrison towns still keep 600-year-old dress and dialect alive.'),
  ],
  'bijie': [
    Landmark(icon: 'azalea', photo: 'azalea', nameTr: 'Yüz Li Açelya Kuşağı', nameEn: 'Hundred-Li Azalea Belt', descTr: 'Her bahar dağ sırtlarını kaplayan açelya denizi, dünyanın en büyük doğal çiçek bahçesidir.', descEn: 'The sea of azaleas blanketing the ridges each spring is the world\'s largest natural flower garden.'),
    Landmark(icon: 'zhijin', photo: 'zhijin', nameTr: 'Zhijin Mağarası', nameEn: 'Zhijin Cave', descTr: 'Dev sarkıt ormanlarıyla \'yeraltı sarayı\' Zhijin, Çin\'in en görkemli mağarasıdır.', descEn: 'With forests of giant stalagmites, the \'underground palace\' of Zhijin is China\'s most spectacular cave.'),
    Landmark(icon: 'caohai', photo: 'caohai', nameTr: 'Caohai Gölü Turnaları', nameEn: 'Caohai Cranes', descTr: 'Weining\'deki sığ göl, her kış nadir kara boyunlu turnaların kışlağı olur.', descEn: 'The shallow lake at Weining becomes the winter home of rare black-necked cranes.'),
    Landmark(icon: 'potato', photo: 'potato', nameTr: 'Patates Başkenti', nameEn: 'Potato Capital', descTr: 'Serin yaylaların patatesi Bijie\'yi Çin\'in patates ambarı yapar; Weining patatesi ülkece ünlüdür.', descEn: 'Highland potatoes make Bijie China\'s potato barn; Weining spuds are famous nationwide.'),
  ],
  'qujing': [
    Landmark(icon: 'rapeseed', photo: 'rapeseed', nameTr: 'Luoping Kolza Denizi', nameEn: 'Luoping Canola Sea', descTr: 'Her şubat Luoping ovasını kaplayan altın sarısı kolza tarlaları, arıcıları ve fotoğrafçıları çeker.', descEn: 'Each February the golden canola fields of Luoping draw beekeepers and photographers alike.'),
    Landmark(icon: 'ham', photo: 'ham', nameTr: 'Xuanwei Jambonu', nameEn: 'Xuanwei Ham', descTr: 'Asırlardır tuzlanıp kurutulan Xuanwei jambonu, Yunnan sofrasının gurur kaynağıdır.', descEn: 'Salt-cured for centuries, Xuanwei ham is the pride of the Yunnan table.'),
    Landmark(icon: 'jiulong', photo: 'jiulong', nameTr: 'Jiulong Şelaleleri', nameEn: 'Jiulong Waterfalls', descTr: '\'Dokuz Ejder\' nehrinin basamak basamak dökülen on şelalesi, Çin\'in en güzel şelale dizisidir.', descEn: 'The ten stepped cascades of the \'Nine Dragons\' river form China\'s most beautiful waterfall chain.'),
    Landmark(icon: 'sandforest', photo: 'sandforest', nameTr: 'Renkli Kum Ormanı', nameEn: 'Colourful Sand Forest', descTr: 'Rüzgârın yonttuğu rengârenk kum sütunları, Luliang\'da doğal bir heykel bahçesi kurar.', descEn: 'Wind-carved columns of coloured sand form a natural sculpture garden at Luliang.'),
  ],
  'yuxi': [
    Landmark(icon: 'fuxian', photo: 'fuxian', nameTr: 'Fuxian Gölü', nameEn: 'Fuxian Lake', descTr: 'Çin\'in en derin ikinci gölü, kristal berraklığındaki suyuyla bir dağ aynasıdır.', descEn: 'China\'s second-deepest lake is a mountain mirror of crystal-clear water.'),
    Landmark(icon: 'nieer', photo: 'nieer', nameTr: 'Besteci Nie Er', nameEn: 'Composer Nie Er', descTr: 'Ulusal marşın bestecisi Nie Er\'in memleketi, onu müzik parkı ve anıtıyla onurlandırır.', descEn: 'Hometown of Nie Er, composer of the national anthem, the city honours him with a music park and memorial.'),
    Landmark(icon: 'chengjiang', photo: 'chengjiang', nameTr: 'Chengjiang Fosilleri', nameEn: 'Chengjiang Fossils', descTr: '530 milyon yıllık Kambriyen fosil yatakları, hayvan yaşamının şafağını gösteren UNESCO mirasıdır.', descEn: 'The 530-million-year-old Cambrian fossil beds are a UNESCO site showing the dawn of animal life.'),
    Landmark(icon: 'kiln', photo: 'kiln', nameTr: 'Yuxi Fırını', nameEn: 'Yuxi Kiln', descTr: 'Yuan döneminden kalma antik fırın, Yunnan\'ın mavi-beyaz seramiğinin doğduğu yerdir.', descEn: 'The ancient Yuan-era kiln is the birthplace of Yunnan\'s blue-and-white ceramics.'),
  ],
  'dali': [
    Landmark(icon: 'threepagodas', photo: 'threepagodas', nameTr: 'Üç Pagoda', nameEn: 'Three Pagodas', descTr: 'Bin yıldır Cangshan eteklerinde yükselen üç zarif pagoda, antik Dali krallığının simgesidir.', descEn: 'Rising at the foot of Cangshan for a thousand years, the three graceful pagodas are the emblem of the ancient Dali kingdom.'),
    Landmark(icon: 'erhai', photo: 'erhai', nameTr: 'Erhai Gölü', nameEn: 'Erhai Lake', descTr: 'Kulak biçimli dağ gölü Erhai, balıkçı sandalları ve göl kıyısı köyleriyle bir tablo gibidir.', descEn: 'The ear-shaped mountain lake of Erhai is a painting of fishing boats and lakeside villages.'),
    Landmark(icon: 'cangshan', photo: 'cangshan', nameTr: 'Cangshan Dağları', nameEn: 'Cangshan Mountains', descTr: 'On dokuz zirvesi karla kaplı Cangshan, Dali\'nin ardında yeşil bir perde gibi yükselir.', descEn: 'With nineteen snow-capped peaks, Cangshan rises like a green curtain behind Dali.'),
    Landmark(icon: 'wind', photo: 'wind', nameTr: 'Rüzgâr, Çiçek, Kar, Ay', nameEn: 'Wind, Flower, Snow, Moon', descTr: 'Xiaguan rüzgârı, Shangguan çiçeği, Cangshan karı ve Erhai ayı — Dali\'nin dört güzelliği bir şiirdir.', descEn: 'Xiaguan wind, Shangguan flowers, Cangshan snow and the Erhai moon — Dali\'s four beauties read like a poem.'),
  ],
  'lijiang': [
    Landmark(icon: 'oldtown', photo: 'oldtown', nameTr: 'Lijiang Eski Şehri', nameEn: 'Lijiang Old Town', descTr: 'Kanallar ve kiremit çatılı ahşap evlerle örülü UNESCO şehri, Naxi kültürünün yaşayan kalbidir.', descEn: 'Woven of canals and tile-roofed timber houses, the UNESCO town is the living heart of Naxi culture.'),
    Landmark(icon: 'snowmountain', photo: 'snowmountain', nameTr: 'Yeşim Ejder Karlı Dağı', nameEn: 'Jade Dragon Snow Mountain', descTr: '5.596 metrelik buzullu zirve, şehrin üzerinde uyuyan bir yeşim ejder gibi parlar.', descEn: 'The 5,596-metre glaciated peak gleams over the town like a sleeping jade dragon.'),
    Landmark(icon: 'dongba', photo: 'dongba', nameTr: 'Dongba Yazısı', nameEn: 'Dongba Script', descTr: 'Naxi rahiplerinin resim-yazısı Dongba, dünyada hâlâ yaşayan tek piktografik yazıdır.', descEn: 'The Naxi priests\' picture-writing, Dongba, is the world\'s last living pictographic script.'),
    Landmark(icon: 'tigerleaping', photo: 'tigerleaping', nameTr: 'Kaplan Atlayan Geçidi', nameEn: 'Tiger Leaping Gorge', descTr: 'Efsaneye göre bir kaplanın tek sıçrayışta aştığı geçit, dünyanın en derin kanyonlarındandır.', descEn: 'The gorge a tiger is said to have cleared in one leap is among the deepest canyons on earth.'),
  ],
  'lincang': [
    Landmark(icon: 'dianhong', photo: 'dianhong', nameTr: 'Dianhong Çayı', nameEn: 'Dianhong Black Tea', descTr: 'Fengqing\'in altın tomurcuklu kızıl çayı Dianhong, dünyaya Yunnan\'ın adını duyurdu.', descEn: 'Fengqing\'s golden-bud black tea, Dianhong, carried Yunnan\'s name to the world.'),
    Landmark(icon: 'wadrum', photo: 'wadrum', nameTr: 'Va Ahşap Davulu', nameEn: 'Wa Wooden Drum', descTr: 'Va halkının kutsal ahşap davulları, dağ köylerinde saç savuran davul dansıyla gümbürder.', descEn: 'The sacred wooden drums of the Wa people thunder through hill villages in the hair-swinging drum dance.'),
    Landmark(icon: 'teatrees', photo: 'teatrees', nameTr: 'Antik Çay Ağaçları', nameEn: 'Ancient Tea Trees', descTr: 'Binlerce yıllık yabani çay ağaçlarının anavatanı Lincang, çayın doğduğu ormanları saklar.', descEn: 'Home to wild tea trees thousands of years old, Lincang guards the forests where tea was born.'),
    Landmark(icon: 'lancang', photo: 'lancang', nameTr: 'Lancang Nehri', nameEn: 'Lancang River', descTr: 'Mekong\'un yukarı kolu Lancang, dev barajlarıyla vadileri aydınlatarak güneye akar.', descEn: 'The upper Mekong, the Lancang flows south, lighting the valleys with its giant dams.'),
  ],
  'puer': [
    Landmark(icon: 'tea', photo: 'tea', nameTr: 'Pu\'er Çayı', nameEn: 'Pu\'er Tea', descTr: 'Yıllandıkça olgunlaşan preslenmiş Pu\'er çayı, adını bu dağ şehrinden alan yaşayan bir hazinedir.', descEn: 'Pressed Pu\'er tea, mellowing as it ages, is a living treasure named after this mountain city.'),
    Landmark(icon: 'coffee', photo: 'coffee', nameTr: 'Çin\'in Kahve Başkenti', nameEn: 'China\'s Coffee Capital', descTr: 'Çin kahvesinin yarıdan fazlası Pu\'er\'in sisli yamaçlarında yetişir; şehir latte kokar.', descEn: 'More than half of China\'s coffee grows on Pu\'er\'s misty slopes; the city smells of lattes.'),
    Landmark(icon: 'teahorse', photo: 'teahorse', nameTr: 'Çay-At Yolu', nameEn: 'Tea Horse Road', descTr: 'Katır kervanlarının çayı Tibet\'e taşıdığı antik yol, Pu\'er\'den başlayıp bulutlara tırmanırdı.', descEn: 'The ancient road where mule caravans carried tea to Tibet began at Pu\'er and climbed into the clouds.'),
    Landmark(icon: 'peafowl', photo: 'peafowl', nameTr: 'Yeşil Tavus Kuşu', nameEn: 'Green Peafowl', descTr: 'Nadir yeşil tavus kuşunun son sığınaklarından olan tropik ormanlar, şehrin yaban tacıdır.', descEn: 'Tropical forests sheltering the rare green peafowl are the city\'s wild crown.'),
  ],
  'baoshan': [
    Landmark(icon: 'volcano', photo: 'volcano', nameTr: 'Tengchong Volkanları', nameEn: 'Tengchong Volcanoes', descTr: 'Doksan yedi sönmüş volkan konisi, Tengchong ovasını ay yüzeyine çevirir.', descEn: 'Ninety-seven dormant volcanic cones turn the Tengchong plain into a lunar landscape.'),
    Landmark(icon: 'rehai', photo: 'rehai', nameTr: 'Rehai Kaplıcaları', nameEn: 'Rehai Hot Sea', descTr: 'Kaynayan \'Sıcak Deniz\' vadisinde gayzerler tüter; yumurtalar kaynak sularında pişer.', descEn: 'In the boiling \'Hot Sea\' valley geysers steam and eggs cook in the spring pools.'),
    Landmark(icon: 'heshun', photo: 'heshun', nameTr: 'Heshun Kasabası', nameEn: 'Heshun Town', descTr: 'Yurtdışına açılan tüccarların taş kasabası Heshun, Çin\'in en eski köy kütüphanesini barındırır.', descEn: 'Heshun, stone town of merchants who ventured abroad, keeps China\'s oldest village library.'),
    Landmark(icon: 'gaoligong', photo: 'gaoligong', nameTr: 'Gaoligong Dağları', nameEn: 'Gaoligong Mountains', descTr: 'Kelebek vadileri ve sıcak ormanlarıyla Gaoligong, bir canlı türleri hazinesidir.', descEn: 'With butterfly valleys and warm forests, Gaoligong is a treasure house of species.'),
  ],
  'deyang': [
    Landmark(icon: 'sanxingdui', photo: 'sanxingdui', nameTr: 'Sanxingdui Kalıntıları', nameEn: 'Sanxingdui Ruins', descTr: 'Fırlak gözlü dev bronz maskeler, 3.000 yıllık gizemli Shu uygarlığını gün ışığına çıkardı.', descEn: 'Giant bronze masks with bulging eyes brought the mysterious 3,000-year-old Shu civilisation to light.'),
    Landmark(icon: 'jiannanchun', photo: 'jiannanchun', nameTr: 'Jiannanchun Likörü', nameEn: 'Jiannanchun Liquor', descTr: 'Tang sarayına sunulan Mianzhu baijiu\'su Jiannanchun, bin beş yüz yıldır damıtılır.', descEn: 'Jiannanchun, the Mianzhu baijiu once served at the Tang court, has been distilled for fifteen centuries.'),
    Landmark(icon: 'nianhua', photo: 'nianhua', nameTr: 'Mianzhu Yılbaşı Baskıları', nameEn: 'Mianzhu New Year Prints', descTr: 'El boyaması tahta baskı yılbaşı resimleri, kapılara bereket ve renk asar.', descEn: 'Hand-painted woodblock New Year pictures hang fortune and colour on doorways.'),
    Landmark(icon: 'turbine', photo: 'turbine', nameTr: 'Ağır Sanayi Başkenti', nameEn: 'Heavy Industry Capital', descTr: 'Ülkenin dev türbin ve jeneratörlerinin çoğu Deyang\'ın atölyelerinde dövülür.', descEn: 'Most of the nation\'s giant turbines and generators are forged in Deyang\'s workshops.'),
  ],
  'mianyang': [
    Landmark(icon: 'libai', photo: 'libai', nameTr: 'Li Bai\'nin Memleketi', nameEn: 'Li Bai\'s Hometown', descTr: 'Şairlerin ölümsüzü Li Bai, Jiangyou\'nun dağları arasında büyüdü; dizeleri hâlâ burada yankılanır.', descEn: 'Li Bai, the immortal of poets, grew up among Jiangyou\'s mountains; his verses still echo here.'),
    Landmark(icon: 'sciencecity', photo: 'sciencecity', nameTr: 'Bilim Şehri', nameEn: 'Science City', descTr: 'Çin\'in tek \'Bilim ve Teknoloji Şehri\' unvanlı kenti, laboratuvarları ve ekranlarıyla geleceği kurar.', descEn: 'China\'s only city titled \'Science and Technology City\' builds the future with labs and screens.'),
    Landmark(icon: 'qiang', photo: 'qiang', nameTr: 'Qiang Taş Kuleleri', nameEn: 'Qiang Stone Towers', descTr: 'Beichuan\'ın dağ köylerinde Qiang halkının taş gözetleme kuleleri asırlardır ayaktadır.', descEn: 'In Beichuan\'s mountain villages the stone watchtowers of the Qiang people have stood for centuries.'),
    Landmark(icon: 'mifen', photo: 'mifen', nameTr: 'Mianyang Pirinç Şehriyesi', nameEn: 'Mianyang Rice Noodles', descTr: 'İnce pirinç şehriyesi, sabahları tavuk ve sakatat suyuyla buharlanan şehrin uyanışıdır.', descEn: 'Fine rice noodles steaming in chicken and offal broth are how the city wakes each morning.'),
  ],
  'nanchong': [
    Landmark(icon: 'langzhong', photo: 'langzhong', nameTr: 'Langzhong Antik Şehri', nameEn: 'Langzhong Ancient City', descTr: 'Feng shui\'ye göre kurulmuş en iyi korunan antik şehir, nehir kıvrımının kucağında uyur.', descEn: 'The best-preserved ancient city laid out by feng shui sleeps in the embrace of a river bend.'),
    Landmark(icon: 'silk', photo: 'silk', nameTr: 'İpek Başkenti', nameEn: 'Silk Capital', descTr: 'İki bin yıllık dokuma geleneğiyle Nanchong, Çin\'in batıdaki ipek başkentidir.', descEn: 'With two thousand years of weaving, Nanchong is China\'s silk capital of the west.'),
    Landmark(icon: 'zhangfei', photo: 'zhangfei', nameTr: 'Zhang Fei Sığır Eti', nameEn: 'Zhang Fei Beef', descTr: 'Üç Krallık kahramanı Zhang Fei\'nin şehrinde kurutulan baharatlı sığır eti, onun adını taşır.', descEn: 'Spiced cured beef from the city of Three Kingdoms hero Zhang Fei bears his name.'),
    Landmark(icon: 'zhude', photo: 'zhude', nameTr: 'Zhu De\'nin Memleketi', nameEn: 'Zhu De\'s Hometown', descTr: 'Mareşal Zhu De\'nin Yilong\'daki mütevazı evi, modern tarihin hac duraklarındandır.', descEn: 'Marshal Zhu De\'s modest home in Yilong is a pilgrimage stop of modern history.'),
  ],
  'yibin': [
    Landmark(icon: 'wuliangye', photo: 'wuliangye', nameTr: 'Wuliangye Likörü', nameEn: 'Wuliangye Liquor', descTr: 'Beş tahıldan damıtılan Wuliangye, Çin\'in en değerli baijiu markalarındandır.', descEn: 'Distilled from five grains, Wuliangye is among China\'s most prized baijiu brands.'),
    Landmark(icon: 'firstcity', photo: 'firstcity', nameTr: 'Yangtze\'nin İlk Şehri', nameEn: 'First City on the Yangtze', descTr: 'Min ve Jinsha nehirlerinin kavuştuğu yerde Yangtze doğar; Yibin bu yüzden \'ilk şehir\'dir.', descEn: 'Where the Min and Jinsha rivers meet, the Yangtze is born; hence Yibin is its \'first city\'.'),
    Landmark(icon: 'bamboosea', photo: 'bamboosea', nameTr: 'Shunan Bambu Denizi', nameEn: 'Shunan Bamboo Sea', descTr: 'Yüz yirmi tepeyi örten bambu okyanusu, rüzgârda dalgalanan yeşil bir denizdir.', descEn: 'An ocean of bamboo cloaking a hundred and twenty hills sways like a green sea in the wind.'),
    Landmark(icon: 'ranmian', photo: 'ranmian', nameTr: 'Alevli Erişte', nameEn: 'Burning Noodles', descTr: 'Yağıyla tutuşturulabilecek kadar susuz yoğrulan \'ranmian\', Yibin kahvaltısının acılı yıldızıdır.', descEn: 'Kneaded so dry its oil can catch flame, \'ranmian\' is the fiery star of a Yibin breakfast.'),
  ],
  'luzhou': [
    Landmark(icon: 'laojiao', photo: 'laojiao', nameTr: 'Laojiao Mahzenleri', nameEn: 'Laojiao Cellars', descTr: '1573\'ten beri kesintisiz kullanılan çamur fermantasyon çukurları, kokulu baijiu\'nun kalbidir.', descEn: 'Mud fermentation pits in continuous use since 1573 are the heart of fragrant baijiu.'),
    Landmark(icon: 'port', photo: 'port', nameTr: 'Yangtze Limanı', nameEn: 'Yangtze Port', descTr: 'İki nehrin kavşağındaki liman şehri, Sichuan\'ın denize açılan su kapısıdır.', descEn: 'The port city at the meeting of two rivers is Sichuan\'s water gate to the sea.'),
    Landmark(icon: 'longan', photo: 'longan', nameTr: 'Longan Bahçeleri', nameEn: 'Longan Orchards', descTr: 'Nehir vadilerinin sıcak yamaçlarında yetişen longan, \'ejder gözü\' denen bal tatlı meyvedir.', descEn: 'Grown on warm river slopes, longan is the honey-sweet fruit called \'dragon\'s eye\'.'),
    Landmark(icon: 'umbrella', photo: 'umbrella', nameTr: 'Yağlı Kağıt Şemsiyeler', nameEn: 'Oil-Paper Umbrellas', descTr: 'Fenshui ustalarının el yapımı yağlı kağıt şemsiyeleri, dört yüz yıllık zarif bir zanaattır.', descEn: 'Handmade oil-paper umbrellas of Fenshui masters are a graceful four-hundred-year craft.'),
  ],
  'leshan': [
    Landmark(icon: 'giantbuddha', photo: 'giantbuddha', nameTr: 'Leshan Dev Budası', nameEn: 'Leshan Giant Buddha', descTr: 'Kayaya oyulmuş 71 metrelik oturan Buda, bin iki yüz yıldır nehirlerin kavşağını izler.', descEn: 'Carved into the cliff, the 71-metre seated Buddha has watched the river junction for twelve centuries.'),
    Landmark(icon: 'emei', photo: 'emei', nameTr: 'Emei Dağı', nameEn: 'Mount Emei', descTr: 'Budizmin dört kutsal dağından Emei\'nin Altın Zirvesi, bulut denizinin üstünde parlar.', descEn: 'Golden Summit of Emei, one of Buddhism\'s four sacred mountains, shines above a sea of clouds.'),
    Landmark(icon: 'monkeys', photo: 'monkeys', nameTr: 'Emei Makakları', nameEn: 'Emei Macaques', descTr: 'Dağ patikalarının haylaz makakları, hacıların çantalarını arsızca yoklamalarıyla ünlüdür.', descEn: 'The mischievous macaques of the mountain paths are famous for boldly frisking pilgrims\' bags.'),
    Landmark(icon: 'qiaojiao', photo: 'qiaojiao', nameTr: 'Qiaojiao Sığır Çorbası', nameEn: 'Qiaojiao Beef Soup', descTr: 'Şifalı otlarla kaynayan sığır çorbası \'qiaojiao\', Leshan sokak sofralarının yüz yıllık klasiğidir.', descEn: 'Beef soup simmered with herbs, \'qiaojiao\' is the century-old classic of Leshan street tables.'),
  ],
  'zigong': [
    Landmark(icon: 'saltwell', photo: 'saltwell', nameTr: 'Bin Metrelik Tuz Kuyuları', nameEn: 'Kilometre-Deep Salt Wells', descTr: 'Dünyada bin metreyi ilk aşan Shenhai kuyusu, iki bin yıllık tuz şehrinin zaferidir.', descEn: 'The Shenhai well, first on earth past a thousand metres, is the triumph of the two-thousand-year salt city.'),
    Landmark(icon: 'lantern', photo: 'lantern', nameTr: 'Zigong Fener Festivali', nameEn: 'Zigong Lantern Festival', descTr: 'Devasa ışıklı fener bahçeleri, her yeni yılda şehri bir masal diyarına çevirir.', descEn: 'Gardens of colossal glowing lanterns turn the city into a fairyland every new year.'),
    Landmark(icon: 'dinosaur', photo: 'dinosaur', nameTr: 'Dinozor Müzesi', nameEn: 'Dinosaur Museum', descTr: 'Jura katmanlarından fışkıran binlerce fosil, Zigong\'u Çin\'in dinozor başkenti yapar.', descEn: 'Thousands of fossils erupting from Jurassic beds make Zigong China\'s dinosaur capital.'),
    Landmark(icon: 'rabbit', photo: 'rabbit', nameTr: 'Soğuk Tavşan', nameEn: 'Cold Rabbit', descTr: 'Acılı soğuk servis edilen \'lengtu\' tavşanı, Sichuan\'ın en cesur mezesinin memleketi buradadır.', descEn: 'Spicy cold-served \'lengtu\' rabbit calls this city home — Sichuan\'s boldest appetiser.'),
  ],
  'panzhihua': [
    Landmark(icon: 'steel', photo: 'steel', nameTr: 'Vanadyum-Titanyum Başkenti', nameEn: 'Vanadium-Titanium Capital', descTr: 'Dağların içine kurulmuş dev çelik kenti, dünyanın en zengin vanadyum-titanyum yataklarını işler.', descEn: 'The giant steel city built into the mountains works the world\'s richest vanadium-titanium deposits.'),
    Landmark(icon: 'fruitvalley', photo: 'fruitvalley', nameTr: 'Güneş Meyveleri Vadisi', nameEn: 'Sunny Fruit Valley', descTr: 'Kurak-sıcak vadinin mangoları ve narları, kışın bile güneşle olgunlaşır.', descEn: 'Mangoes and pomegranates of the dry-hot valley ripen in sunshine even in winter.'),
    Landmark(icon: 'sunshine', photo: 'sunshine', nameTr: 'Kış Güneşi Şehri', nameEn: 'Winter Sun City', descTr: 'Yılda 2.700 saat güneşiyle Panzhihua, kışı ılık geçirmek isteyenlerin sağlık durağıdır.', descEn: 'With 2,700 hours of sun a year, Panzhihua is the wellness stop for a mild winter.'),
    Landmark(icon: 'jinsha', photo: 'jinsha', nameTr: 'Jinsha Nehri', nameEn: 'Jinsha River', descTr: 'Altın kumlu Jinsha, derin vadileri yararak şehrin ortasından coşkuyla akar.', descEn: 'The golden-sanded Jinsha surges through the city, carving its deep valleys.'),
  ],
  'dazhou': [
    Landmark(icon: 'gas', photo: 'gas', nameTr: 'Doğalgaz Başkenti', nameEn: 'Natural Gas Capital', descTr: 'Puguang dev gaz sahası, Dazhou\'yu Çin\'in doğalgaz enerji üssü yapar.', descEn: 'The giant Puguang field makes Dazhou China\'s natural-gas energy base.'),
    Landmark(icon: 'ba', photo: 'ba', nameTr: 'Ba Krallığı Mirası', nameEn: 'Ba Kingdom Legacy', descTr: 'Söğüt yaprağı kılıçlarıyla antik Ba savaşçılarının toprakları, Luojiaba kalıntılarında konuşur.', descEn: 'The land of ancient Ba warriors with willow-leaf swords speaks through the Luojiaba ruins.'),
    Landmark(icon: 'dengying', photo: 'dengying', nameTr: 'Lamba Gölgesi Sığır Eti', nameEn: 'Lamp-Shadow Beef', descTr: 'Işığı geçirecek kadar ince kesilen baharatlı \'dengying\' eti, adını gölge oyunundan alır.', descEn: 'Sliced thin enough to glow against light, spicy \'dengying\' beef takes its name from shadow plays.'),
    Landmark(icon: 'hanque', photo: 'hanque', nameTr: 'Han Taş Kapıları', nameEn: 'Han Stone Gate-Towers', descTr: 'Quxian\'daki iki bin yıllık taş \'que\' kuleleri, Han mimarisinin ayakta kalan zarafetidir.', descEn: 'The two-thousand-year-old stone \'que\' towers at Quxian are the surviving grace of Han architecture.'),
  ],
  'guangyuan': [
    Landmark(icon: 'jianmen', photo: 'jianmen', nameTr: 'Jianmen Geçidi', nameEn: 'Jianmen Pass', descTr: '\'Bir kişi tutsa on bin kişi geçemez\' denen kılıç dağı geçidi, Shu yolunun kilididir.', descEn: 'The sword-mountain pass where \'one man can hold off ten thousand\' is the lock of the Shu road.'),
    Landmark(icon: 'wuzetian', photo: 'wuzetian', nameTr: 'Wu Zetian\'ın Doğduğu Şehir', nameEn: 'Wu Zetian\'s Birthplace', descTr: 'Çin\'in tek kadın imparatoru Wu Zetian burada doğdu; Huangze Tapınağı onu bin yıldır anar.', descEn: 'China\'s only woman emperor, Wu Zetian, was born here; the Huangze Temple has honoured her for a millennium.'),
    Landmark(icon: 'plankroad', photo: 'plankroad', nameTr: 'Antik Tahta Yollar', nameEn: 'Ancient Plank Roads', descTr: 'Uçurumlara çakılmış tahta yollar, \'göğe çıkmaktan zor\' Shu yolunun cesaret anıtıdır.', descEn: 'Plank roads nailed to sheer cliffs are the monument of daring on the Shu road \'harder than climbing to heaven\'.'),
    Landmark(icon: 'cypress', photo: 'cypress', nameTr: 'Cuiyun Servi Koridoru', nameEn: 'Cuiyun Cypress Corridor', descTr: 'Üç Krallık\'tan kalma on binlerce antik servi, antik yolu yeşil bir tünele çevirir.', descEn: 'Tens of thousands of ancient cypresses from the Three Kingdoms era turn the old road into a green tunnel.'),
  ],
  'yaan': [
    Landmark(icon: 'panda', photo: 'panda', nameTr: 'Pandanın Anavatanı', nameEn: 'Cradle of the Panda', descTr: 'Dev panda bilime ilk kez 1869\'da Baoxing\'de tanıtıldı; Bifengxia üssü bu mirası yaşatır.', descEn: 'The giant panda was first described for science at Baoxing in 1869; the Bifengxia base keeps that legacy alive.'),
    Landmark(icon: 'rain', photo: 'rain', nameTr: 'Yağmur Şehri', nameEn: 'Rain City', descTr: '\'Ya yağmuru\' neredeyse her gece çatıları yıkar; şehir yeşilin bin tonuyla parlar.', descEn: 'The \'Ya rain\' washes the rooftops almost nightly; the city gleams in a thousand greens.'),
    Landmark(icon: 'mengding', photo: 'mengding', nameTr: 'Mengding Dağı Çayı', nameEn: 'Mount Mengding Tea', descTr: 'İnsan eliyle çay ilk kez iki bin yıl önce Mengding\'de dikildi; dağ, çay kültürünün beşiğidir.', descEn: 'Tea was first planted by human hands on Mengding two thousand years ago; the mountain is the cradle of tea culture.'),
    Landmark(icon: 'yayu', photo: 'yayu', nameTr: 'Ya Balığı', nameEn: 'Ya Fish', descTr: 'Kar sularında yetişen efsanevi Ya balığı, kaynayan güveçlerde şehrin sofra gururudur.', descEn: 'The fabled Ya fish of snow-fed streams is the city\'s pride, served in bubbling casseroles.'),
  ],
  'xianyang': [
    Landmark(icon: 'qincapital', photo: 'qincapital', nameTr: 'Qin İmparatorluk Başkenti', nameEn: 'Qin Imperial Capital', descTr: 'Çin\'i ilk birleştiren Qin hanedanının başkenti burasıydı; imparatorluğun yolu Xianyang\'dan geçti.', descEn: 'Here stood the capital of the Qin, first unifiers of China; the road to empire ran through Xianyang.'),
    Landmark(icon: 'qianling', photo: 'qianling', nameTr: 'Qianling Anıtmezarı', nameEn: 'Qianling Mausoleum', descTr: 'Wu Zetian ile eşinin dağa oyulan ortak mezarı, yazısız dikilitaşıyla tarihe meydan okur.', descEn: 'The mountain tomb shared by Wu Zetian and her husband defies history with its blank stele.'),
    Landmark(icon: 'zhengguo', photo: 'zhengguo', nameTr: 'Zhengguo Kanalı', nameEn: 'Zhengguo Canal', descTr: 'İki bin yıllık sulama kanalı, Guanzhong ovasını Qin\'in tahıl ambarına çevirdi.', descEn: 'The two-thousand-year-old irrigation canal turned the Guanzhong plain into the granary of Qin.'),
    Landmark(icon: 'guokui', photo: 'guokui', nameTr: 'Guokui Gözlemesi', nameEn: 'Guokui Flatbread', descTr: 'Kazan kapağı kadar büyük ve çıtır \'guokui\' ekmeği, Shaanxi sofrasının asırlık atıştırmalığıdır.', descEn: 'Crisp \'guokui\' flatbread, big as a pot lid, is the centuries-old snack of the Shaanxi table.'),
  ],
  'baoji': [
    Landmark(icon: 'bronze', photo: 'bronze', nameTr: 'Bronz Eserler Başkenti', nameEn: 'Bronze Ware Capital', descTr: '\'Çin\' adının bilinen ilk yazımını taşıyan He zun dahil binlerce Zhou bronzu, Baoji\'de gün yüzüne çıktı.', descEn: 'Thousands of Zhou bronzes, including the He zun bearing the first known writing of the name \'China\', surfaced at Baoji.'),
    Landmark(icon: 'famen', photo: 'famen', nameTr: 'Famen Tapınağı', nameEn: 'Famen Temple', descTr: 'Buda\'nın parmak kemiği kalıntısını saklayan Famen, Tang imparatorlarının kutsal hazinesiydi.', descEn: 'Guarding the finger-bone relic of the Buddha, Famen was the sacred treasury of Tang emperors.'),
    Landmark(icon: 'taibai', photo: 'taibai', nameTr: 'Taibai Dağı', nameEn: 'Mount Taibai', descTr: 'Qinling\'in 3.771 metrelik çatısı Taibai, yazın bile karlı zirvesiyle efsanelere konu olur.', descEn: 'Taibai, the 3,771-metre roof of the Qinling, feeds legends with a summit snowy even in summer.'),
    Landmark(icon: 'saozi', photo: 'saozi', nameTr: 'Saozi Eriştesi', nameEn: 'Saozi Noodles', descTr: 'Ekşi-acı et soslu Qishan \'saozi\' eriştesi, üç bin yıllık Zhou mutfağının yaşayan tadıdır.', descEn: 'Qishan \'saozi\' noodles in sour-spicy meat sauce are the living taste of three-thousand-year-old Zhou cooking.'),
  ],
  'sanming': [
    Landmark(icon: 'danxia', photo: 'danxia', nameTr: 'Taining Danxia', nameEn: 'Taining Danxia', descTr: 'Kızıl kayalıkları ve kanyonlarıyla UNESCO jeoparkı, gökten inmiş bir taş labirentidir.', descEn: 'With red cliffs and gorges, the UNESCO geopark is a maze of stone fallen from the sky.'),
    Landmark(icon: 'shaxian', photo: 'shaxian', nameTr: 'Sha İlçesi Atıştırmalıkları', nameEn: 'Sha County Snacks', descTr: 'Ucuz wonton ve karışık eriştesiyle Sha İlçesi mutfağı tüm Çin\'e yayıldı.', descEn: 'With cheap wontons and mixed noodles, Sha County snacks have spread across all China.'),
    Landmark(icon: 'forest', photo: 'forest', nameTr: 'Yeşil Başkent', nameEn: 'Green Capital', descTr: 'Çin\'in en ormanlık şehri Sanming, temiz havası ve yeşil dağlarıyla nefes aldırır.', descEn: 'China\'s most forested city, Sanming breathes with clean air and green mountains.'),
    Landmark(icon: 'goldenlake', photo: 'goldenlake', nameTr: 'Altın Göl', nameEn: 'Golden Lake', descTr: 'Danxia kayalıkları arasında uzanan göl, tekne turlarıyla keşfedilir.', descEn: 'Stretching among the Danxia cliffs, the lake is explored by boat.'),
  ],
  'ningde': [
    Landmark(icon: 'mudflat', photo: 'mudflat', nameTr: 'Xiapu Gelgit Düzlükleri', nameEn: 'Xiapu Mudflats', descTr: 'Gelgitle değişen ışıltılı çamur düzlükleri, dünyanın en çok fotoğraflanan kıyılarındandır.', descEn: 'Shimmering tidal flats shifting with the sea are among the world\'s most photographed shores.'),
    Landmark(icon: 'whitetea', photo: 'whitetea', nameTr: 'Fuding Beyaz Çayı', nameEn: 'Fuding White Tea', descTr: 'Tüylü tomurcuklarıyla kurutulan beyaz çay, yıllandıkça değer kazanır.', descEn: 'Dried with downy buds, the white tea grows more prized as it ages.'),
    Landmark(icon: 'taimu', photo: 'taimu', nameTr: 'Taimu Dağı', nameEn: 'Mount Taimu', descTr: 'Denize bakan granit kuleleri ve mağaralarıyla dağ, \'denizin yanındaki peri diyarı\'dır.', descEn: 'With granite spires and caves above the sea, the mountain is a \'fairyland by the sea\'.'),
    Landmark(icon: 'croaker', photo: 'croaker', nameTr: 'Sarı Kroker Balığı', nameEn: 'Yellow Croaker', descTr: 'Sakin koylarda yetiştirilen büyük sarı kroker balığı, şehrin deniz hazinesidir.', descEn: 'Large yellow croaker farmed in sheltered bays is the city\'s marine treasure.'),
  ],
  'shaoguan': [
    Landmark(icon: 'redcliff', photo: 'redcliff', nameTr: 'Danxia Dağı', nameEn: 'Mount Danxia', descTr: '\'Danxia\' yer şeklinin adını aldığı kızıl kayalık dağ, eşsiz oyma kuleleriyle ünlüdür.', descEn: 'The red rock mountain that named the \'Danxia\' landform is famed for its carved pillars.'),
    Landmark(icon: 'chantemple', photo: 'chantemple', nameTr: 'Nanhua Tapınağı', nameEn: 'Nanhua Temple', descTr: 'Zen Budizminin Altıncı Patriği Huineng\'in tapınağı, mezhebin kutsal merkezidir.', descEn: 'Temple of Huineng, Sixth Patriarch of Chan Buddhism, it is the sect\'s sacred centre.'),
    Landmark(icon: 'ancestor', photo: 'ancestor', nameTr: 'Zhuji Sokağı', nameEn: 'Zhuji Lane', descTr: 'Milyonlarca güneyli Çinlinin atalarının göç ettiği sokak, bir kök-bulma yeridir.', descEn: 'The lane from which millions of southern Chinese trace their migrating ancestors is a place of roots.'),
    Landmark(icon: 'yaodance', photo: 'yaodance', nameTr: 'Yao Halkı', nameEn: 'Yao People', descTr: 'Dağ köylerinde yaşayan Yao halkı, rengârenk kostümleri ve davullu danslarıyla bilinir.', descEn: 'Living in mountain villages, the Yao people are known for colourful costumes and drum dances.'),
  ],
  'zhanjiang': [
    Landmark(icon: 'oyster', photo: 'oyster', nameTr: 'Zhanjiang İstiridyesi', nameEn: 'Zhanjiang Oyster', descTr: 'Sıcak güney sularında yetişen iri istiridyeler, kömürde ızgara edilip sofraları süsler.', descEn: 'Plump oysters grown in warm southern waters are grilled over coals to grace the table.'),
    Landmark(icon: 'navy', photo: 'navy', nameTr: 'Donanma Limanı', nameEn: 'Naval Port', descTr: 'Güney Deniz Filosu\'na ev sahipliği yapan derin liman, ülkenin güney deniz kapısıdır.', descEn: 'Home to the South Sea Fleet, the deep port is the nation\'s southern sea gate.'),
    Landmark(icon: 'mangrove', photo: 'mangrove', nameTr: 'Mangrov Ormanı', nameEn: 'Mangrove Forest', descTr: 'Çin\'in en büyük mangrov ormanı, gelgit sularında balıkçıllara ve yengeçlere yuva olur.', descEn: 'China\'s largest mangrove forest shelters egrets and crabs in its tidal waters.'),
    Landmark(icon: 'donghai', photo: 'donghai', nameTr: 'Donghai Adası', nameEn: 'Donghai Island', descTr: 'Uzun kumsalı ve rüzgârıyla ada, güneşlenme ve sörfün gözde durağıdır.', descEn: 'With a long beach and steady wind, the island is a favourite for sunbathing and surfing.'),
  ],
  'maoming': [
    Landmark(icon: 'lychee', photo: 'lychee', nameTr: 'Liçi Başkenti', nameEn: 'Lychee Capital', descTr: 'Çin\'in en büyük liçi üreticisi Maoming, imparatorlara liçi yollayan topraklardır.', descEn: 'China\'s largest lychee producer, Maoming is the land that once sent lychees to emperors.'),
    Landmark(icon: 'refinery', photo: 'refinery', nameTr: 'Petrokimya Üssü', nameEn: 'Petrochemical Base', descTr: 'Güney Çin\'in en büyük rafinerilerinden biri, şehrin sanayi gücünü besler.', descEn: 'One of southern China\'s largest refineries powers the city\'s industrial might.'),
    Landmark(icon: 'ladyxian', photo: 'ladyxian', nameTr: 'Lady Xian', nameEn: 'Lady Xian', descTr: 'Güneyi birleştiren kadın kahraman Lady Xian, halkın bin yıldır andığı bir efsanedir.', descEn: 'Lady Xian, the heroine who unified the south, has been honoured by the people for a thousand years.'),
    Landmark(icon: 'seaside', photo: 'seaside', nameTr: 'Sahil', nameEn: 'Seaside', descTr: '\'Çin\'in Bir Numaralı Plajı\' sayılan uzun sahil, ailelere altın kumlar sunar.', descEn: 'Hailed as \'China\'s No.1 Beach\', the long shore offers families golden sands.'),
  ],
  'zhaoqing': [
    Landmark(icon: 'sevenstar', photo: 'sevenstar', nameTr: 'Yedi Yıldız Kayalıkları', nameEn: 'Seven Star Crags', descTr: 'Göl üstünde yükselen yedi kireçtaşı tepe, \'Guangdong\'un Guilin\'i\' diye anılır.', descEn: 'Seven limestone crags rising from a lake are called the \'Guilin of Guangdong\'.'),
    Landmark(icon: 'inkstone', photo: 'inkstone', nameTr: 'Duan Mürekkep Taşı', nameEn: 'Duan Inkstone', descTr: 'Kaligrafinin dört hazinesinden Duan mürekkep taşı, bin yıldır burada yontulur.', descEn: 'The Duan inkstone, one of calligraphy\'s four treasures, has been carved here for a thousand years.'),
    Landmark(icon: 'dinghu', photo: 'dinghu', nameTr: 'Dinghu Dağı', nameEn: 'Mount Dinghu', descTr: 'Çin\'in ilk doğa koruma alanı, gür yağmur ormanı ve şelaleleriyle \'canlı oksijen barı\'dır.', descEn: 'China\'s first nature reserve, with lush rainforest and falls, is a living \'oxygen bar\'.'),
    Landmark(icon: 'songwall', photo: 'songwall', nameTr: 'Song Şehir Suru', nameEn: 'Song City Wall', descTr: 'Tam korunmuş Song dönemi suru, antik Zhaoqing\'i bir tarih halkasıyla sarar.', descEn: 'The fully preserved Song-era wall rings old Zhaoqing with a circle of history.'),
  ],
  'huizhou': [
    Landmark(icon: 'westlake', photo: 'westlake', nameTr: 'Huizhou Batı Gölü', nameEn: 'Huizhou West Lake', descTr: 'Şair Su Shi\'nin sürgünde sevdiği göl, söğütleri ve setleriyle bir şiirdir.', descEn: 'Loved by the exiled poet Su Shi, the lake is a poem of willows and causeways.'),
    Landmark(icon: 'luofu', photo: 'luofu', nameTr: 'Luofu Dağı', nameEn: 'Mount Luofu', descTr: 'Taocu münzevilerin ve şifalı bitkilerin dağı, \'güneyin ilk kutsal dorukları\'ndandır.', descEn: 'Mountain of Taoist hermits and healing herbs, it is among \'the south\'s first sacred peaks\'.'),
    Landmark(icon: 'alchemy', photo: 'alchemy', nameTr: 'Ge Hong Simyası', nameEn: 'Ge Hong Alchemy', descTr: 'Simyacı-hekim Ge Hong, geleneksel tıbbın temellerini bu dağda yazdı.', descEn: 'The alchemist-physician Ge Hong wrote the foundations of traditional medicine on this mountain.'),
    Landmark(icon: 'xunliao', photo: 'xunliao', nameTr: 'Xunliao Körfezi', nameEn: 'Xunliao Bay', descTr: 'Berrak suları ve yumuşak kumuyla körfez, güney sahilinin sakin tatil noktasıdır.', descEn: 'With clear water and soft sand, the bay is the south coast\'s tranquil resort.'),
  ],
  'meizhou': [
    Landmark(icon: 'weilongwu', photo: 'weilongwu', nameTr: 'Hakka Başkenti', nameEn: 'Hakka Capital', descTr: '\'Dünya Hakka başkenti\' Meizhou, at nalı biçimli geleneksel weilongwu evleriyle bilinir.', descEn: 'The \'world Hakka capital\', Meizhou is known for its horseshoe-shaped weilongwu homes.'),
    Landmark(icon: 'saltchicken', photo: 'saltchicken', nameTr: 'Tuzda Tavuk', nameEn: 'Salt-Baked Chicken', descTr: 'Sıcak tuza gömülerek pişirilen Hakka tavuğu, narin etiyle imza lezzettir.', descEn: 'Hakka chicken baked buried in hot salt is a signature dish of tender meat.'),
    Landmark(icon: 'football', photo: 'football', nameTr: 'Futbolun Memleketi', nameEn: 'Home of Football', descTr: 'Çin futbolunun beşiği sayılan şehir, ülkeye nesiller boyu yıldız oyuncu yetiştirdi.', descEn: 'Regarded as a cradle of Chinese football, the city has raised star players for generations.'),
    Landmark(icon: 'plum', photo: 'plum', nameTr: 'Erik Çiçeği', nameEn: 'Plum Blossom', descTr: 'Adı \'erik\' anlamına gelen şehir, kışın açan erik çiçekleriyle bezenir.', descEn: 'The city whose name means \'plum\' is adorned with plum blossoms in winter.'),
  ],
  'jiangmen': [
    Landmark(icon: 'diaolou', photo: 'diaolou', nameTr: 'Kaiping Kuleleri', nameEn: 'Kaiping Diaolou', descTr: 'Yurtdışından dönen göçmenlerin yaptığı çok katlı kale-kuleler UNESCO mirasıdır.', descEn: 'The multi-storey fortress-towers built by returning emigrants are UNESCO-listed.'),
    Landmark(icon: 'qiaoxiang', photo: 'qiaoxiang', nameTr: 'Gurbetçi Diyarı', nameEn: 'Overseas Chinese Home', descTr: 'Dünyaya yayılmış milyonlarca gurbetçinin memleketi, Doğu-Batı kültürünü harmanlar.', descEn: 'Hometown of millions of overseas Chinese, it blends East and West.'),
    Landmark(icon: 'chenpi', photo: 'chenpi', nameTr: 'Xinhui Mandalina Kabuğu', nameEn: 'Dried Tangerine Peel', descTr: 'Yıllandırılan Xinhui mandalina kabuğu, hem baharat hem değerli bir ilaçtır.', descEn: 'Aged Xinhui tangerine peel is both a spice and a prized medicine.'),
    Landmark(icon: 'birds', photo: 'birds', nameTr: 'Kuşlar Cenneti', nameEn: 'Birds Paradise', descTr: 'Tek bir dev banyan ağacının oluşturduğu koru, on binlerce balıkçıla yuva olur.', descEn: 'A grove formed from a single giant banyan tree is home to tens of thousands of egrets.'),
  ],
  'yangjiang': [
    Landmark(icon: 'knife', photo: 'knife', nameTr: 'Bıçak Başkenti', nameEn: 'Knife Capital', descTr: 'Çin\'in mutfak bıçaklarının büyük kısmı, asırlık demircilik geleneğiyle burada dövülür.', descEn: 'A huge share of China\'s kitchen knives are forged here by a centuries-old smithing tradition.'),
    Landmark(icon: 'shipwreck', photo: 'shipwreck', nameTr: 'Nanhai 1 Batığı', nameEn: 'Nanhai No.1 Wreck', descTr: 'Deniz İpek Yolu\'ndan kalan Song gemisi, hazinesiyle bir su altı müzesinde sergilenir.', descEn: 'A Song-era ship from the Maritime Silk Road is displayed with its treasure in an underwater museum.'),
    Landmark(icon: 'hailing', photo: 'hailing', nameTr: 'Hailing Adası', nameEn: 'Hailing Island', descTr: 'Güneşli plajları ve dalgalarıyla ada, Guangdong\'un gözde deniz tatil yeridir.', descEn: 'With sunny beaches and waves, the island is Guangdong\'s favourite seaside resort.'),
    Landmark(icon: 'kite', photo: 'kite', nameTr: 'Uçurtma Şehri', nameEn: 'Kite City', descTr: 'Weifang\'la birlikte Çin\'in iki uçurtma başkentinden biri, gökyüzünü her sonbahar süsler.', descEn: 'One of China\'s two kite capitals alongside Weifang, it fills the autumn sky.'),
  ],
  'qingyuan': [
    Landmark(icon: 'rafting', photo: 'rafting', nameTr: 'Rafting Diyarı', nameEn: 'Rafting Capital', descTr: 'Coşkun dağ dereleriyle Qingyuan, Çin\'in \'rafting memleketi\' diye anılır.', descEn: 'With rushing mountain streams, Qingyuan is called China\'s \'home of rafting\'.'),
    Landmark(icon: 'chicken', photo: 'chicken', nameTr: 'Qingyuan Tavuğu', nameEn: 'Qingyuan Chicken', descTr: 'İnce kemikli, lezzetli yerel tavuk ırkı, Kanton sofrasının en aranan kümes hayvanıdır.', descEn: 'The fine-boned, flavourful local chicken breed is the most sought-after fowl on the Cantonese table.'),
    Landmark(icon: 'hotspring', photo: 'hotspring', nameTr: 'Kaplıcalar', nameEn: 'Hot Springs', descTr: 'Dağ vadilerinden çıkan sıcak mineralli sular, hafta sonu kaçamaklarının merkezidir.', descEn: 'Hot mineral waters from the mountain valleys are the centre of weekend escapes.'),
    Landmark(icon: 'yaoterrace', photo: 'yaoterrace', nameTr: 'Yao Pirinç Terasları', nameEn: 'Yao Rice Terraces', descTr: 'Liannan Yao halkının dağ yamaçlarına oyduğu teraslar, asırlık emeğin merdivenidir.', descEn: 'Terraces carved into the slopes by the Liannan Yao are a staircase of centuries of toil.'),
  ],
  'chaozhou': [
    Landmark(icon: 'guangjibridge', photo: 'guangjibridge', nameTr: 'Guangji Köprüsü', nameEn: 'Guangji Bridge', descTr: 'Ortasındaki sandallarla açılıp kapanan antik köprü, Çin\'in dört ünlü köprüsünden biridir.', descEn: 'The ancient bridge that opens and closes with boats at its centre is one of China\'s four famous bridges.'),
    Landmark(icon: 'woodcarving', photo: 'woodcarving', nameTr: 'Yaldızlı Ahşap Oyma', nameEn: 'Gilded Woodcarving', descTr: 'Altın varakla kaplı çok katmanlı ahşap oymalar, tapınakları ışıltıyla doldurur.', descEn: 'Gold-leafed, multi-layered woodcarvings fill the temples with shimmer.'),
    Landmark(icon: 'chaoxiu', photo: 'chaoxiu', nameTr: 'Chaozhou İşlemesi', nameEn: 'Chaozhou Embroidery', descTr: 'Kabartmalı altın iplik nakışıyla Chaozhou işlemesi, güney Çin\'in en gösterişlisidir.', descEn: 'With raised gold-thread stitching, Chaozhou embroidery is the most opulent in southern China.'),
    Landmark(icon: 'kaiyuan', photo: 'kaiyuan', nameTr: 'Kaiyuan Tapınağı', nameEn: 'Kaiyuan Temple', descTr: '1.200 yıllık tapınak, Tang döneminden kalma sakin avlularıyla şehrin kalbidir.', descEn: 'The 1,200-year-old temple, with calm Tang-era courtyards, is the heart of the city.'),
  ],
  'jieyang': [
    Landmark(icon: 'citygate', photo: 'citygate', nameTr: 'Jinxian Kapısı', nameEn: 'Jinxian Gate', descTr: 'Nehre bakan zarif ahşap kule kapısı, antik Jieyang\'ın ayakta kalan simgesidir.', descEn: 'The graceful timber tower gate over the river is the surviving emblem of old Jieyang.'),
    Landmark(icon: 'jade', photo: 'jade', nameTr: 'Yeşim Başkenti', nameEn: 'Jade Capital', descTr: 'Yangmei kasabası, Çin\'in en büyük yeşim oyma ve ticaret merkezlerindendir.', descEn: 'The town of Yangmei is one of China\'s largest jade carving and trading hubs.'),
    Landmark(icon: 'jieyanglou', photo: 'jieyanglou', nameTr: 'Jieyang Kulesi', nameEn: 'Jieyang Tower', descTr: 'Geleneksel saçaklı dev kule, Chaoshan kültürünün modern bir anıtıdır.', descEn: 'The giant tower with traditional eaves is a modern monument to Chaoshan culture.'),
    Landmark(icon: 'beefbroth', photo: 'beefbroth', nameTr: 'Chaoshan Dana Çorbası', nameEn: 'Chaoshan Beef Broth', descTr: 'Taze dananın berrak suda anında haşlandığı çorba, bölgenin gurur lezzetidir.', descEn: 'Fresh beef blanched in a clear broth is the region\'s prized dish.'),
  ],
  'yunfu': [
    Landmark(icon: 'marble', photo: 'marble', nameTr: 'Taş Krallığı', nameEn: 'Stone Kingdom', descTr: 'Mermer ve taş işlemenin başkenti Yunfu, dünyaya cilalı taş ihraç eder.', descEn: 'Capital of marble and stone working, Yunfu exports polished stone to the world.'),
    Landmark(icon: 'patriarch', photo: 'patriarch', nameTr: 'Altıncı Patrik', nameEn: 'Sixth Patriarch', descTr: 'Zen ustası Huineng\'in doğduğu topraklar, Guoen Tapınağı ile kutsanır.', descEn: 'Birthplace of the Chan master Huineng, the land is hallowed by the Guoen Temple.'),
    Landmark(icon: 'tianlu', photo: 'tianlu', nameTr: 'Tianlu Dağı', nameEn: 'Mount Tianlu', descTr: 'Bulutlara değen zirveleri ve çay bahçeleriyle dağ, şehrin yeşil tacıdır.', descEn: 'With cloud-touched peaks and tea gardens, the mountain is the city\'s green crown.'),
    Landmark(icon: 'xijiang', photo: 'xijiang', nameTr: 'Batı Nehri', nameEn: 'West River', descTr: 'Güneyin büyük su yolu olan İnci Nehri\'nin ana kolu, şehrin önünden akar.', descEn: 'The main branch of the Pearl River, the south\'s great waterway, flows past the city.'),
  ],
  'liuzhou': [
    Landmark(icon: 'luosifen', photo: 'luosifen', nameTr: 'Salyangoz Eriştesi', nameEn: 'Snail Rice Noodles', descTr: 'Keskin kokulu ekşi-acı salyangoz eriştesi \'luosifen\', tüm Çin\'i saran bir lezzettir.', descEn: 'Pungent, sour-spicy snail rice noodles, \'luosifen\', are a flavour craze sweeping all China.'),
    Landmark(icon: 'autocity', photo: 'autocity', nameTr: 'Otomobil Şehri', nameEn: 'Auto City', descTr: 'Halkın aldığı küçük şehir araçlarıyla Liuzhou, Çin\'in en büyük otomobil üslerindendir.', descEn: 'With the small city cars its people love, Liuzhou is one of China\'s biggest auto bases.'),
    Landmark(icon: 'karst', photo: 'karst', nameTr: 'Liu Nehri Karstı', nameEn: 'Liu River Karst', descTr: 'Şehri saran kireçtaşı tepeler ve nehir kıvrımı, sanayi kentine doğa güzelliği katar.', descEn: 'Limestone hills and a river bend wrapping the city lend natural beauty to the industrial town.'),
    Landmark(icon: 'liuhou', photo: 'liuhou', nameTr: 'Şair Liu Zongyuan', nameEn: 'Poet Liu Zongyuan', descTr: 'Tang şairi ve valisi Liu Zongyuan\'ın anısı, şehir parkında bir tapınakla yaşar.', descEn: 'The memory of Tang poet and governor Liu Zongyuan lives in a shrine in the city park.'),
  ],
  'wuzhou': [
    Landmark(icon: 'gemstone', photo: 'gemstone', nameTr: 'Yapay Mücevher Başkenti', nameEn: 'Gemstone Capital', descTr: 'Dünya yapay değerli taşlarının büyük kısmı, bu nehir kentinin atölyelerinde kesilir.', descEn: 'A huge share of the world\'s man-made gemstones is cut in this river city\'s workshops.'),
    Landmark(icon: 'liubaotea', photo: 'liubaotea', nameTr: 'Liubao Çayı', nameEn: 'Liubao Dark Tea', descTr: 'Yıllandırılan koyu Liubao çayı, nemli güneyin sindirim dostu klasik içeceğidir.', descEn: 'Aged dark Liubao tea is the humid south\'s digestive classic.'),
    Landmark(icon: 'turtlejelly', photo: 'turtlejelly', nameTr: 'Kaplumbağa Jölesi', nameEn: 'Turtle Jelly', descTr: 'Şifalı otlardan yapılan acımsı siyah jöle \'guilinggao\', sıcak günlerin ferahlatıcısıdır.', descEn: 'The bitter black herbal jelly \'guilinggao\' is a cooling treat on hot days.'),
    Landmark(icon: 'dragonmother', photo: 'dragonmother', nameTr: 'Ejderha Ana Tapınağı', nameEn: 'Dragon Mother Temple', descTr: 'Nehir tanrıçası Ejderha Ana\'ya adanan tapınak, nehir halkının asırlık inancıdır.', descEn: 'Dedicated to the river goddess Dragon Mother, the temple is the river folk\'s age-old faith.'),
  ],
  'beihai': [
    Landmark(icon: 'silverbeach', photo: 'silverbeach', nameTr: 'Gümüş Kumsal', nameEn: 'Silver Beach', descTr: 'Pırıl pırıl ince kumuyla \'göğün altındaki birinci plaj\', kilometrelerce uzanır.', descEn: 'With glittering fine sand, \'the number-one beach under heaven\' stretches for miles.'),
    Landmark(icon: 'pearl', photo: 'pearl', nameTr: 'İnci Şehri', nameEn: 'Pearl City', descTr: 'Hepu\'nun Güney Denizi incileri, imparatorluk haraçlarından beri en kıymetlisi sayılır.', descEn: 'Hepu\'s South Sea pearls have been prized as the finest since imperial tribute days.'),
    Landmark(icon: 'weizhou', photo: 'weizhou', nameTr: 'Weizhou Adası', nameEn: 'Weizhou Island', descTr: 'Çin\'in en genç volkanik adası, kara kayalıkları ve mercanlarıyla dalgıçları çeker.', descEn: 'China\'s youngest volcanic island draws divers with black cliffs and coral.'),
    Landmark(icon: 'oldstreet', photo: 'oldstreet', nameTr: 'Eski Sokak', nameEn: 'Old Street', descTr: 'Yüz yıllık sömürge revaklı binalar, Deniz İpek Yolu limanının geçmişini yaşatır.', descEn: 'Century-old colonnaded colonial buildings keep alive the past of the Maritime Silk Road port.'),
  ],
  'qinzhou': [
    Landmark(icon: 'nixingpottery', photo: 'nixingpottery', nameTr: 'Nixing Çömleği', nameEn: 'Nixing Pottery', descTr: 'Fırında kendiliğinden renk değiştiren Nixing çömlekçiliği, Çin\'in dört ünlü çömleğindendir.', descEn: 'Nixing pottery, which changes colour by itself in the kiln, is one of China\'s four famous wares.'),
    Landmark(icon: 'dolphin', photo: 'dolphin', nameTr: 'Beyaz Yunus', nameEn: 'White Dolphin', descTr: 'Sanniang Körfezi\'nde yüzen nadir Çin beyaz yunusları, şehrin sevimli simgesidir.', descEn: 'Rare Chinese white dolphins swimming in Sanniang Bay are the city\'s beloved emblem.'),
    Landmark(icon: 'oysterfarm', photo: 'oysterfarm', nameTr: 'İstiridye Diyarı', nameEn: 'Oyster Land', descTr: 'Sığ koylarda yetiştirilen dev istiridyeler, Qinzhou\'yu Çin\'in istiridye başkenti yapar.', descEn: 'Giant oysters farmed in shallow bays make Qinzhou China\'s oyster capital.'),
    Landmark(icon: 'general', photo: 'general', nameTr: 'General Feng Zicai', nameEn: 'General Feng Zicai', descTr: 'Sınırı savunan yaşlı general Feng Zicai\'nin memleketi, kahramanlık anılarıyla doludur.', descEn: 'Hometown of the aged general Feng Zicai who defended the frontier, it is full of heroic memory.'),
  ],
  'guigang': [
    Landmark(icon: 'lotus', photo: 'lotus', nameTr: 'Nilüfer Şehri', nameEn: 'Lotus City', descTr: 'Yaz boyu açan dev nilüfer tarlalarıyla Guigang, \'nilüfer şehri\' diye anılır.', descEn: 'With vast lotus fields blooming all summer, Guigang is called the \'lotus city\'.'),
    Landmark(icon: 'uprising', photo: 'uprising', nameTr: 'Jintian Ayaklanması', nameEn: 'Jintian Uprising', descTr: 'Tarihi sarsan Taiping Ayaklanması\'nın ilk kıvılcımı bu topraklarda çakıldı.', descEn: 'The first spark of the history-shaking Taiping Uprising was struck on these lands.'),
    Landmark(icon: 'nanshan', photo: 'nanshan', nameTr: 'Nanshan Tapınağı', nameEn: 'Nanshan Temple', descTr: 'Kayaya oyulmuş bin yıllık mağara tapınağı, imparator yazıtlarıyla bezelidir.', descEn: 'The thousand-year cave temple carved into the rock is adorned with imperial inscriptions.'),
    Landmark(icon: 'sugarcane', photo: 'sugarcane', nameTr: 'Şeker Kamışı', nameEn: 'Sugarcane', descTr: 'Verimli nehir ovası, Çin\'in en büyük şeker üretiminin tatlı kaynağıdır.', descEn: 'The fertile river plain is the sweet source of China\'s largest sugar production.'),
  ],
  'yulin': [
    Landmark(icon: 'medicine', photo: 'medicine', nameTr: 'Şifalı Ot Pazarı', nameEn: 'Herbal Medicine Market', descTr: 'Güney Çin\'in en büyük geleneksel ilaç pazarı, binlerce şifalı bitkiyi bir araya getirir.', descEn: 'Southern China\'s largest traditional-medicine market gathers thousands of healing herbs.'),
    Landmark(icon: 'goldenpalace', photo: 'goldenpalace', nameTr: 'Yuntian Sarayı', nameEn: 'Yuntian Palace', descTr: 'Altın kaplı dev kültür sarayı, görkemli heykelleri ve salonlarıyla şaşırtır.', descEn: 'The gold-clad giant cultural palace astonishes with grand statues and halls.'),
    Landmark(icon: 'lychee', photo: 'lychee', nameTr: 'Liçi Bahçeleri', nameEn: 'Lychee Groves', descTr: 'Sıcak tepelerde yetişen tatlı liçi, yaz pazarlarının kırmızı hazinesidir.', descEn: 'Sweet lychees grown on warm hills are the red treasure of summer markets.'),
    Landmark(icon: 'beef', photo: 'beef', nameTr: 'Yulin Sığır Eti', nameEn: 'Yulin Beef', descTr: 'Baharatla kurutulan \'niuba\' sığır eti, bölgenin asırlık imza atıştırmalığıdır.', descEn: 'Spice-cured \'niuba\' beef is the region\'s age-old signature snack.'),
  ],
  'baise': [
    Landmark(icon: 'redbase', photo: 'redbase', nameTr: 'Baise Ayaklanması', nameEn: 'Baise Uprising', descTr: 'Genç Deng Xiaoping\'in yönettiği ayaklanma, kızıl tarihin önemli bir dönüm noktasıdır.', descEn: 'The uprising led by a young Deng Xiaoping is a key turning point in red history.'),
    Landmark(icon: 'sinkhole', photo: 'sinkhole', nameTr: 'Leye Obrukları', nameEn: 'Leye Sinkholes', descTr: 'Dünyanın en büyük dev obruk kümesi, derinliklerinde gizli ormanlar barındırır.', descEn: 'The world\'s largest cluster of giant sinkholes hides forests in its depths.'),
    Landmark(icon: 'mango', photo: 'mango', nameTr: 'Mango Başkenti', nameEn: 'Mango Capital', descTr: 'Sıcak vadileriyle Baise, Çin\'in en büyük mango bahçelerine ev sahipliği yapar.', descEn: 'With its hot valleys, Baise hosts China\'s largest mango groves.'),
    Landmark(icon: 'aluminum', photo: 'aluminum', nameTr: 'Alüminyum Şehri', nameEn: 'Aluminium City', descTr: 'Zengin boksit yataklarıyla şehir, Çin\'in alüminyum sanayisinin güney üssüdür.', descEn: 'Rich in bauxite, the city is the southern base of China\'s aluminium industry.'),
  ],
  'hechi': [
    Landmark(icon: 'longevity', photo: 'longevity', nameTr: 'Bama Uzun Ömür Diyarı', nameEn: 'Bama Longevity', descTr: 'Yüz yaşını aşan sakinleriyle Bama, dünyanın ünlü \'uzun ömür memleketi\'dir.', descEn: 'With residents past a hundred years, Bama is a world-famous \'home of longevity\'.'),
    Landmark(icon: 'folksong', photo: 'folksong', nameTr: 'Liu Sanjie', nameEn: 'Liu Sanjie', descTr: 'Türkü perisi Liu Sanjie\'nin efsanesi, karşılıklı şarkı atışmalarında yaşar.', descEn: 'The legend of the song fairy Liu Sanjie lives on in antiphonal singing contests.'),
    Landmark(icon: 'bronzedrum', photo: 'bronzedrum', nameTr: 'Tunç Davul', nameEn: 'Bronze Drum', descTr: 'Zhuang ve dağ halklarının kutsal tunç davulları, en yoğun şekilde burada toplanır.', descEn: 'The sacred bronze drums of the Zhuang and mountain peoples are most densely gathered here.'),
    Landmark(icon: 'geopark', photo: 'geopark', nameTr: 'Karst Jeoparkı', nameEn: 'Karst Geopark', descTr: 'Obrukları, mağaraları ve yer altı nehirleriyle bölge, bir karst harikalar diyarıdır.', descEn: 'With sinkholes, caves and underground rivers, the region is a karst wonderland.'),
  ],
  'laibin': [
    Landmark(icon: 'sugarcity', photo: 'sugarcity', nameTr: 'Şeker Başkenti', nameEn: 'Sugar Capital', descTr: 'Uçsuz şeker kamışı tarlalarıyla Laibin, \'Çin\'in şeker şehri\' diye anılır.', descEn: 'With endless cane fields, Laibin is called \'China\'s sugar city\'.'),
    Landmark(icon: 'yao', photo: 'yao', nameTr: 'Dayao Dağı Yao', nameEn: 'Dayao Yao People', descTr: 'Jinxiu\'nun Dayao dağlarında yaşayan Yao halkı, beş ayrı boyuyla kültür hazinesidir.', descEn: 'The Yao of Jinxiu\'s Dayao mountains, in five distinct branches, are a cultural treasure.'),
    Landmark(icon: 'hongshui', photo: 'hongshui', nameTr: 'Kızıl Su Nehri', nameEn: 'Hongshui River', descTr: 'Vadileri yaran güçlü Kızıl Su Nehri, barajları ve manzaralarıyla bölgeyi besler.', descEn: 'The mighty Hongshui River carving the valleys feeds the region with dams and views.'),
    Landmark(icon: 'shengtang', photo: 'shengtang', nameTr: 'Shengtang Dağı', nameEn: 'Mount Shengtang', descTr: 'Bulut denizi ve şelaleleriyle dağ, Dayao sıradağlarının en yüksek zirvesidir.', descEn: 'With a sea of clouds and waterfalls, the mountain is the highest peak of the Dayao range.'),
  ],
  'chongzuo': [
    Landmark(icon: 'waterfall', photo: 'waterfall', nameTr: 'Detian Şelalesi', nameEn: 'Detian Falls', descTr: 'Vietnam sınırındaki Detian, Asya\'nın en büyük ülkeler arası şelalesidir.', descEn: 'On the Vietnam border, Detian is Asia\'s largest transnational waterfall.'),
    Landmark(icon: 'langur', photo: 'langur', nameTr: 'Beyaz Başlı Langur', nameEn: 'White-Headed Langur', descTr: 'Yalnızca bu kireçtaşı tepelerde yaşayan nadir beyaz başlı langur, dünyanın en ender maymunlarındandır.', descEn: 'Living only in these limestone hills, the rare white-headed langur is among the world\'s most endangered monkeys.'),
    Landmark(icon: 'rockart', photo: 'rockart', nameTr: 'Huashan Kaya Resimleri', nameEn: 'Huashan Rock Art', descTr: 'Zuojiang kayalıklarına 2.000 yıl önce çizilen kızıl figürler UNESCO mirasıdır.', descEn: 'Red figures painted on the Zuojiang cliffs 2,000 years ago are UNESCO-listed.'),
    Landmark(icon: 'borderpass', photo: 'borderpass', nameTr: 'Dostluk Geçidi', nameEn: 'Friendship Pass', descTr: 'Vietnam\'a açılan tarihî sınır kapısı, güney İpek Yolu\'nun kara kapısıdır.', descEn: 'The historic border gate to Vietnam is the land gate of the southern Silk Road.'),
  ],
  'beijing': [
    Landmark(
      icon: 'great-wall',
